...
RSpec.describe Account do
  ...
  describe 'support_email' do
    ...
    it 'returns the support email from inbox if inbox value is present' do
      account.update(support_email: 'support@ahmedkhaled4d.com')
      with_modified_env MAILER_SENDER_EMAIL: 'hello@ahmedkhaled4d.com' do
        expect(account.support_email).to eq('support@ahmedkhaled4d.com')
      end
    end
    ...
    it 'returns the support email from ENV if inbox value is nil' do
      ...
      with_modified_env MAILER_SENDER_EMAIL: 'hello@ahmedkhaled4d.com' do
        expect(account.support_email).to eq('hello@ahmedkhaled4d.com')
      end
    end
