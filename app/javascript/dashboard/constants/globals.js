export default {
  ...
  DOCS_URL: 'https://www.ahmedkhaled4d.com/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://www.ahmedkhaled4d.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.ahmedkhaled4d.com/content.json',
