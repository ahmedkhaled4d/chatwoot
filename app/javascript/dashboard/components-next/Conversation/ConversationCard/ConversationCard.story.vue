...
const conversationWithoutMeta = {
  meta: {
    sender: {
      ...
      email: 'candice@ahmedkhaled4d.com',
      id: 29,
  ...
  messages: [
    {
      ...
      conversation: {
        ...
        contactInbox: {
          sourceId: 'candice@ahmedkhaled4d.com',
        },
      },
    },
  ],
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      contact_inbox: {
        source_id: 'candice@ahmedkhaled4d.com',
      },
    },
    sender: {
      id: 1,
...
const conversationWithMeta = {
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      last_activity_at: 1730885428,
      contact_inbox: {
        source_id: 'willy@ahmedkhaled4d.com',
      },
    },
    sender: {
      id: 1,
